...
<html lang="en">
<head>
    <title>Code coverage report for library/src/instance/constructor.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">library/src/instance/</a> constructor.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import defaults from './defaults'
...
&nbsp;
	<span class="missing-if-branch" title="else path not taken" >E</span>if (this.defaults.mobile === isMobile() || this.defaults.desktop === !isMobile()) {
